...
def print_summary(results: List[dict]):
    ...
    print(f"{Colors.GREEN}[PASS]: {passed_count}{Colors.ENDC}")
    print(f"{Colors.RED}[FAIL]: {failed_count}{Colors.ENDC}")
    print(f"{Colors.YELLOW}[SKIP]: {skipped_count}{Colors.ENDC}")
    print()
